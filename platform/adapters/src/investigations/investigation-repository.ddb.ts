/**
 * InvestigationRepository - DynamoDB Implementation
 *
...
/**
 * InvestigationRepositoryDdb
 *
 * DDD: Infrastructure adapter implementing Investigation repository using DynamoDB.
 * Generated from x-dynamodb metadata in OpenAPI schema.
 */

import type { InvestigationRepository } from "@alertworth/services/investigations";
...
/**
 * InvestigationRepositoryDdb using DynamoDB table (type: core)
 *
 * Entity Type: INVESTIGATION_CASE
 * Entity Token: INVESTIGATION_CASE
 * SK Prefix: INVESTIGATION_CASE
 */
export class InvestigationRepositoryDdb implements InvestigationRepository {
  private readonly TABLE_NAME: string;
  // Metadata from x-dynamodb annotation - all values are dynamic
  private readonly ENTITY_TYPE = "INVESTIGATION_CASE";
  private readonly ENTITY_TOKEN = "INVESTIGATION_CASE";
  private readonly SK_PREFIX = "INVESTIGATION_CASE";
  ...
  private readonly DOMAIN = "INVESTIGATIONS";
  private readonly ENTITY_TYPE_PK = "INVESTIGATION_CASES";
  private generateCorrelationId(): string {
    const domainPrefix = "inv";
