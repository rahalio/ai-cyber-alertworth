/**
 * DismissalPolicyRepository - DynamoDB Implementation
 *
...
/**
 * DismissalPolicyRepositoryDdb
 *
 * DDD: Infrastructure adapter implementing DismissalPolicy repository using DynamoDB.
 * Generated from x-dynamodb metadata in OpenAPI schema.
 */

import type { DismissalPolicyRepository } from "@alertworth/services/scoring";
...
/**
 * DismissalPolicyRepositoryDdb using DynamoDB table (type: core)
 *
 * Entity Type: DISMISSAL_POLICY
 * Entity Token: DISMISSAL_POLICY
 * SK Prefix: DISMISSAL_POLICY
 */
export class DismissalPolicyRepositoryDdb implements DismissalPolicyRepository {
  private readonly TABLE_NAME: string;
  // Metadata from x-dynamodb annotation - all values are dynamic
  private readonly ENTITY_TYPE = "DISMISSAL_POLICY";
  private readonly ENTITY_TOKEN = "DISMISSAL_POLICY";
  private readonly SK_PREFIX = "DISMISSAL_POLICY";
  ...
  private readonly ENTITY_TYPE_PK = "DISMISSAL_POLICYS";
