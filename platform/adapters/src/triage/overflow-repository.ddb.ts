/**
 * OverflowRepository - DynamoDB Implementation
 *
...
/**
 * OverflowRepositoryDdb
 *
 * DDD: Infrastructure adapter implementing Overflow repository using DynamoDB.
 * Generated from x-dynamodb metadata in OpenAPI schema.
 */

import type { OverflowRepository } from "@alertworth/services/triage";
...
/**
 * OverflowRepositoryDdb using DynamoDB table (type: core)
 *
 * Entity Type: OVERFLOW_ROUTE
 * Entity Token: OVERFLOW_ROUTE
 * SK Prefix: OVERFLOW_ROUTE
 */
export class OverflowRepositoryDdb implements OverflowRepository {
  private readonly TABLE_NAME: string;
  // Metadata from x-dynamodb annotation - all values are dynamic
  private readonly ENTITY_TYPE = "OVERFLOW_ROUTE";
  private readonly ENTITY_TOKEN = "OVERFLOW_ROUTE";
  private readonly SK_PREFIX = "OVERFLOW_ROUTE";
  ...
  private readonly ENTITY_TYPE_PK = "OVERFLOW_ROUTES";
