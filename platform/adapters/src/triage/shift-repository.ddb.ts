/**
 * ShiftRepository - DynamoDB Implementation
 *
 ...
 * ShiftRepositoryDdb
 *
 * DDD: Infrastructure adapter implementing Shift repository using DynamoDB.
 * Generated from x-dynamodb metadata in OpenAPI schema.
 */

import type { ShiftRepository } from "@alertworth/services/triage";
...
/**
 * ShiftRepositoryDdb using DynamoDB table (type: core)
 *
 * Entity Type: TRIAGE_SHIFT
 * Entity Token: TRIAGE_SHIFT
 * SK Prefix: TRIAGE_SHIFT
 */
export class ShiftRepositoryDdb implements ShiftRepository {
  private readonly TABLE_NAME: string;
  // Metadata from x-dynamodb annotation - all values are dynamic
  private readonly ENTITY_TYPE = "TRIAGE_SHIFT";
  private readonly ENTITY_TOKEN = "TRIAGE_SHIFT";
  private readonly SK_PREFIX = "TRIAGE_SHIFT";
  ...
  private readonly ENTITY_TYPE_PK = "TRIAGE_SHIFTS";
