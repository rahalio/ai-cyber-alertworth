 ...
 * EventRepositoryDdb
 *
 * DDD: Infrastructure adapter implementing Event repository using DynamoDB.
 * Generated from x-dynamodb metadata in OpenAPI schema.
 */

import type { EventRepository } from "@alertworth/services/events";
...
/**
 * EventRepositoryDdb using DynamoDB table (type: core)
 *
 * Entity Type: SECURITY_EVENT
 * Entity Token: SECURITY_EVENT
 * SK Prefix: SECURITY_EVENT
 */
export class EventRepositoryDdb implements EventRepository {
  ...
  private readonly ENTITY_TYPE = "SECURITY_EVENT";
  private readonly ENTITY_TOKEN = "SECURITY_EVENT";
  private readonly SK_PREFIX = "SECURITY_EVENT";
  ...
  private readonly DOMAIN = "EVENTS";
  private readonly ENTITY_TYPE_PK = "SECURITY_EVENTS";
  private generateCorrelationId(): string {
    const domainPrefix = "evt";
