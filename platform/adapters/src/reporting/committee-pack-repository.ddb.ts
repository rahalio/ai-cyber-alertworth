/**
 * CommitteePackRepository - DynamoDB Implementation
 *
...
/**
 * CommitteePackRepositoryDdb
 *
 * DDD: Infrastructure adapter implementing CommitteePack repository using DynamoDB.
 * Generated from x-dynamodb metadata in OpenAPI schema.
 */

import type { CommitteePackRepository } from "@alertworth/services/reporting";
...
/**
 * CommitteePackRepositoryDdb using DynamoDB table (type: core)
 *
 * Entity Type: COMMITTEE_PACK
 * Entity Token: COMMITTEE_PACK
 * SK Prefix: COMMITTEE_PACK
 */
export class CommitteePackRepositoryDdb implements CommitteePackRepository {
  ...
  private readonly ENTITY_TYPE = "COMMITTEE_PACK";
  private readonly ENTITY_TOKEN = "COMMITTEE_PACK";
  private readonly SK_PREFIX = "COMMITTEE_PACK";
  ...
  private readonly ENTITY_TYPE_PK = "COMMITTEE_PACKS";
  ...
  async assembleCommitteePack(input: Parameters<CommitteePackRepository['assembleCommitteePack']>[0]): Promise<Awaited<ReturnType<CommitteePackRepository['assembleCommitteePack']>>> {
