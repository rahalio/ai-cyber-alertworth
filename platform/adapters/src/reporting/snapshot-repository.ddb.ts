 ...
 *
 * DDD: Infrastructure adapter implementing Snapshot repository using DynamoDB.
 * Generated from x-dynamodb metadata in OpenAPI schema.
 */

import type { SnapshotRepository } from "@alertworth/services/reporting";
...
/**
 * SnapshotRepositoryDdb using DynamoDB table (type: core)
 *
 * Entity Type: RESIDUAL_RISK_SNAPSHOT
 * Entity Token: RESIDUAL_RISK_SNAPSHOT
 * SK Prefix: RESIDUAL_RISK_SNAPSHOT
 */
export class SnapshotRepositoryDdb implements SnapshotRepository {
  ...
  private readonly ENTITY_TYPE = "RESIDUAL_RISK_SNAPSHOT";
  private readonly ENTITY_TOKEN = "RESIDUAL_RISK_SNAPSHOT";
  private readonly SK_PREFIX = "RESIDUAL_RISK_SNAPSHOT";
  ...
  private readonly ENTITY_TYPE_PK = "RESIDUAL_RISK_SNAPSHOTS";
  ...
  async listResidualRiskSnapshots(input: Parameters<SnapshotRepository['listResidualRiskSnapshots']>[0]): Promise<Awaited<ReturnType<SnapshotRepository['listResidualRiskSnapshots']>>> {
