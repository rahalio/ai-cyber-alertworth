/**
 * BaselineRepository - DynamoDB Implementation
 *
...
/**
 * BaselineRepositoryDdb
 *
 * DDD: Infrastructure adapter implementing Baseline repository using DynamoDB.
 * Generated from x-dynamodb metadata in OpenAPI schema.
 */

import type { BaselineRepository } from "@alertworth/services/baselines";
...
/**
 * BaselineRepositoryDdb using DynamoDB table (type: core)
 *
 * Entity Type: BEHAVIOUR_BASELINE
 * Entity Token: BEHAVIOUR_BASELINE
 * SK Prefix: BEHAVIOUR_BASELINE
 */
export class BaselineRepositoryDdb implements BaselineRepository {
  private readonly TABLE_NAME: string;
  // Metadata from x-dynamodb annotation - all values are dynamic
  private readonly ENTITY_TYPE = "BEHAVIOUR_BASELINE";
  private readonly ENTITY_TOKEN = "BEHAVIOUR_BASELINE";
  private readonly SK_PREFIX = "BEHAVIOUR_BASELINE";
  ...
  private readonly DOMAIN = "BASELINES";
  private readonly ENTITY_TYPE_PK = "BEHAVIOUR_BASELINES";
  private generateCorrelationId(): string {
    const domainPrefix = "bsl";
