/**
 * AttackPathRepository - DynamoDB Implementation
 *
...
/**
 * AttackPathRepositoryDdb
 *
 * DDD: Infrastructure adapter implementing AttackPath repository using DynamoDB.
 * Generated from x-dynamodb metadata in OpenAPI schema.
 */

import type { AttackPathRepository } from "@alertworth/services/baselines";
...
/**
 * AttackPathRepositoryDdb using DynamoDB table (type: core)
 *
 * Entity Type: ATTACK_PATH
 * Entity Token: ATTACK_PATH
 * SK Prefix: ATTACK_PATH
 */
export class AttackPathRepositoryDdb implements AttackPathRepository {
  private readonly TABLE_NAME: string;
  // Metadata from x-dynamodb annotation - all values are dynamic
  private readonly ENTITY_TYPE = "ATTACK_PATH";
  private readonly ENTITY_TOKEN = "ATTACK_PATH";
  private readonly SK_PREFIX = "ATTACK_PATH";
  ...
  private readonly ENTITY_TYPE_PK = "ATTACK_PATHS";
