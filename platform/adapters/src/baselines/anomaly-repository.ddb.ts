/**
 * AnomalyRepository - DynamoDB Implementation
 *
...
/**
 * AnomalyRepositoryDdb
 *
 * DDD: Infrastructure adapter implementing Anomaly repository using DynamoDB.
 * Generated from x-dynamodb metadata in OpenAPI schema.
 */

import type { AnomalyRepository } from "@alertworth/services/baselines";
...
/**
 * AnomalyRepositoryDdb using DynamoDB table (type: core)
 *
 * Entity Type: ANOMALY_DETECTION
 * Entity Token: ANOMALY_DETECTION
 * SK Prefix: ANOMALY_DETECTION
 */
export class AnomalyRepositoryDdb implements AnomalyRepository {
  private readonly TABLE_NAME: string;
  // Metadata from x-dynamodb annotation - all values are dynamic
  private readonly ENTITY_TYPE = "ANOMALY_DETECTION";
  private readonly ENTITY_TOKEN = "ANOMALY_DETECTION";
  private readonly SK_PREFIX = "ANOMALY_DETECTION";
  ...
  private readonly ENTITY_TYPE_PK = "ANOMALY_DETECTIONS";
