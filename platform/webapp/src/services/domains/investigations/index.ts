 ...
 *
 * Barrel export for investigations service, types, hooks, and view models.
 *
 * Architecture Rules:
 * - API types: re-exports from @alertworth/core only
...
// ============================================================================
export { investigationsFacade } from './facade';
...
// export type { ... } from './investigations.api-types';
