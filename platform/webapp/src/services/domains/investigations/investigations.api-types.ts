/**
 * Investigations API Types
 *
 * API contract types come from @alertworth/core.
 * This file contains ONLY re-exports - no local API contract definitions.
 */

// ============================================================================
// API Type Re-exports (from @alertworth/core)
// ============================================================================
...
export type {
  // Add types from @alertworth/core/investigations
} from "@alertworth/core";

// Re-export with alias for backward compatibility if needed
// export type CoreInvestigationsItem = InvestigationsItem;
