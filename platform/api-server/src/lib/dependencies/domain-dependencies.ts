...
export async function injectDomainDependencies(
  ...
  if (!domainDeps) {
    ...
    switch (domain) {
      case "baselines":
        domainDeps = buildBaselinesDomainModule(dynamoClient);
        break;
      case "controls":
      ...
      case "identity":
        ...
        break;
      case "indicators":
        domainDeps = buildIndicatorsDomainModule(dynamoClient);
        break;
      case "investigations":
        domainDeps = buildInvestigationsDomainModule(dynamoClient);
        break;
      case "reporting":
      ...
      case "scoring":
        ...
        break;
      case "triage":
        domainDeps = buildTriageDomainModule(dynamoClient);
        break;
      default:
        return;
    }
 ...
 */
export function getBaselinesDeps(
  request: FastifyRequest,
): DomainDependencies["baselines"] {
  return getDomainDeps(request, "baselines");
}
...
export function getIndicatorsDeps(
  request: FastifyRequest,
): DomainDependencies["indicators"] {
  return getDomainDeps(request, "indicators");
}
export function getInvestigationsDeps(
  request: FastifyRequest,
): DomainDependencies["investigations"] {
  return getDomainDeps(request, "investigations");
}
...
export function getTriageDeps(
  request: FastifyRequest,
): DomainDependencies["triage"] {
  return getDomainDeps(request, "triage");
}
